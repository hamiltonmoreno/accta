    ...
    <div className="bg-white border border-gray-200/80 rounded-2xl overflow-hidden animate-fade-up" data-testid="activity-feed">
      <div className="flex items-center justify-between px-5 sm:px-6 py-4 border-b border-gray-100">
        <div className="flex items-center gap-2">
          <Activity className="w-4 h-4 text-grafite" />
      ...
      <div className="divide-y divide-gray-50 max-h-[420px] overflow-y-auto">
        {items.map((item, i) => (
          <button
            ...
            className="w-full flex items-start gap-3 px-5 sm:px-6 py-3.5 hover:bg-gray-50/80 transition-colors text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#C7202F]/40"
