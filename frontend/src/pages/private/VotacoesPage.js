              ...
              >
                ...
                {isAtivo && (
                  <div className="border-t border-slate-200 pt-6 mt-6">
                    ...
                    <button
                      onClick={handleVote}
                      disabled={!selectedPoll || selectedPoll.id !== poll.id || selectedOption === null || voting}
            ...
            {closedPolls.map((poll, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="flex items-center gap-2 text-sm text-primary hover:text-primary/80 font-mono uppercase tracking-wider"
