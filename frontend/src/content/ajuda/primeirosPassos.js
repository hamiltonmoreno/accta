  ...
  artigos: [
    ...
    },
    {
      ...
      faq: [
        ...
        { q: 'Proposta', a: 'Ponto, medida ou tema que um sócio submete para a ordem de trabalhos da Assembleia (Governança e voz).' },
        { q: 'Petição', a: 'Recolha de assinaturas de sócios (1/4 dos votantes) para forçar a convocação de uma Assembleia Geral extraordinária.' },
        { q: 'Esclarecimento', a: 'Pergunta formal dirigida a um órgão social (Direção, Mesa da AG ou Conselho Fiscal), com resposta registada.' },
        { q: 'Reclamação', a: 'Contestação formal de um ato ou decisão que o afeta, com prazo de resposta e direito a recurso à AG.' },
        { q: 'Grupo de trabalho / Comissão', a: 'Estruturas de trabalho criadas pela Direção no módulo de Projetos (Art. 31.e): em regra, grupo de trabalho para algo pontual, comissão para algo continuado.' },
        { q: 'Comissão de Inquérito', a: 'Grupo de 3 membros que apura os factos num processo disciplinar. Não confundir com a "Comissão" do módulo de Projetos.' },
        { q: 'Sanção', a: 'Medida disciplinar aplicada na sequência de um processo (advertência, multa, perda de direitos ou expulsão).' },
      ],
      passos: [
