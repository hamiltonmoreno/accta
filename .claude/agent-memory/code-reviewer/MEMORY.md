...
- [Comunicados Segmentados v2 PR #302 review](review-comunicados-segmentados-pr302.md) — C1: PATCH no ownership check (IDOR); C2: /enviar no ownership check (IDOR); W1: preview-audience missing _enforce_intra_orgao_scope; W2: preview ignores channels (inflated count); W3: ComunicadoUpdate no validators; W4: dispatch sync (timeout risk)
